...
def format_response(weather):
    try:
        ...
        temp = weather['main']['temp']  # You need to define temp variable
...
def get_weather(city):
    ...
    # result['text'] = format_response(weather) # Uncomment if using Tkinter
    
    # icon_name = weather['weather'][0]['icon']
    # open_image(icon_name)  # Uncomment if using Tkinter

# def open_image(icon): # Uncomment if using Tkinter
...
# Uncomment these lines if using Tkinter
